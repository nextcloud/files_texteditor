OC.L10N.register(
    ...
    "This application enables Nextcloud users to open, save and edit text files in the web browser. If enabled, an entry called \"Text file\" in the \"New\" button menu at the top of the web browser appears. When clicked, a new text file opens in the browser and the file can be saved into the current Nextcloud directory. Further, when a text file is clicked in the web browser, it will be opened and editable. If the privileges allow, a user can also edit shared files and save these changes back into the web browser.\nMore information is available in the text editor documentation." : "Цей застосунок дозволяє користувачам Nextcloud відкривати, зберігати та редагувати текстові файли у веб-браузері. Якщо його увімкнено, з'являється пункт \"Текстовий файл\" у меню кнопки \"Створити\" у верхній частині веб-браузера. При натисканні на нього в браузері відкривається новий текстовий файл, який можна зберегти в поточну директорію Nextcloud. Надалі, при натисканні на текстовий файл у веб-браузері, він буде відкриватися і редагуватися. Якщо дозволяють привілеї, користувач також може редагувати спільні файли та зберігати ці зміни назад у веб-браузері.\nБільш детальна інформація доступна в документації до текстового редактора."
},
