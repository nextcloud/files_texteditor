OC.L10N.register(
    ...
    "This application enables Nextcloud users to open, save and edit text files in the web browser. If enabled, an entry called \"Text file\" in the \"New\" button menu at the top of the web browser appears. When clicked, a new text file opens in the browser and the file can be saved into the current Nextcloud directory. Further, when a text file is clicked in the web browser, it will be opened and editable. If the privileges allow, a user can also edit shared files and save these changes back into the web browser.\nMore information is available in the text editor documentation." : "このアプリでは、Nextcloudユーザーはブラウザー上でテキストファイルを開いたり、保存したり、編集することができます。有効にすると、ブラウザ上部の\"新規\"ボタンメニューに\"テキストファイル\"というエントリが表示されます。クリックすると、ブラウザーに新しいテキストファイルが開き、そのファイルをNextcloudに保存できます。許可すれば、他のユーザーと共有ファイルを編集して変更をブラウザに保存することもできます。\n詳細情報はテキストエディタのドキュメントにあります。",
    "Saving…" : "保存中...",
