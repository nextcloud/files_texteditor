OC.L10N.register(
    ...
    "You cannot write to a folder." : "Не можете да записвате в папка",
    ...
    "Invalid range request" : "Невалидна заявка за диапазон",
    "Plain text editor" : "Редактор на обикновен текст",
