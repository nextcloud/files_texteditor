OC.L10N.register(
    ...
    "You cannot write to a folder." : "Δεν μπορείτε να γράψετε σε ένα φάκελο.",
    ...
    "File path not supplied." : "Δεν παρέχεται διαδρομή αρχείου.",
    "File mtime not supplied." : "Δεν παρέχεται χρόνος αρχείου.",
