OC.L10N.register(
    ...
    "This application enables Nextcloud users to open, save and edit text files in the web browser. If enabled, an entry called \"Text file\" in the \"New\" button menu at the top of the web browser appears. When clicked, a new text file opens in the browser and the file can be saved into the current Nextcloud directory. Further, when a text file is clicked in the web browser, it will be opened and editable. If the privileges allow, a user can also edit shared files and save these changes back into the web browser.\nMore information is available in the text editor documentation." : "Bu uygulama, Nextcloud kullanıcılarının metin dosyalarını tarayıcı üzerinde açıp düzenleyebilmesini ve kaydetmesini sağlar. Kullanıma alındığında, tarayıcının üst bölümündeki \"Yeni\" düğmesinde \"Metin dosyası\" seçeneği görüntülenir. Bu seçeneğe tıklandığında tarayıcı içinde yeni bir metin dosyası açılır ve bu dosya geçerli Nextcloud klasörüne kaydedilebilir. Ayrıca tarayıcı içinde bir metin dosyasına tıklandığında dosya açılarak düzenlenebilir. Yeterli izinleri olan bir kullanıcı paylaşılmış dosyaları da tarayıcı üzerinde düzenleyip kaydedebilir.\nAyrıntılı bilgi almak için metin düzenleyici uygulamasının belgelerine bakabilirsiniz."
},
